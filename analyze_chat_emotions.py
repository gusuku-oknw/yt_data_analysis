...
checkpoint_emotion = './saved_model'  # 必要に応じて修正
...
axes[0].set_title('10秒ごとの感情別コメント数（ポジティブ/ニュートラル/ネガティブ）', fontsize=15)
axes[0].set_ylabel('コメント数', fontsize=12)
...
axes[1].set_title('10秒ごとの感情別コメント数（8感情）', fontsize=15)
axes[1].set_xlabel('時間（秒）', fontsize=12)
axes[1].set_ylabel('コメント数', fontsize=12)
