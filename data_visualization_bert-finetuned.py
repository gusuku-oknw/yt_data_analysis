...
file_path = 'chat_messages=SH6HQFhgQ54.csv'
...
# 感情分析モデルの初期設定
checkpoint = 'christian-phu/bert-finetuned-japanese-sentiment'  # モデル名
...
def sentiment_pipeline(messages):
    ...
    for message in messages:
        # トークナイズと推論
        tokens = tokenizer(message, truncation=True, max_length=124,  # モデルに適した最大長を指定
...
df.to_csv(f'chat_messages_with_sentiment_bert-finetuned={file_name}.csv', index=False, encoding='utf-8-sig')
